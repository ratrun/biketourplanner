...
The following steps are simpler and only need the JRE, a jar file and an OSM file.
 ...
 5. For offline usage you may be interested to download a OSM2VectorTiles *.mbtiles file of your area from [OSM2VectorTiles ](http://osm2vectortiles.org/downloads/) and put it to the [mbtiles-server](../mbtiles-server) directory.
