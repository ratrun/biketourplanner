...
var formatTools=require("./tools/format.js"),GHInput=require("./graphhopper/GHInput.js"),GHRoute=require("./graphhopper/GHRoute.js"),mapLayer=require("./map.js"),dataToHtml=function(e,t){var o="";if(e.name)o+="<div class='nameseg'>"+formatTools.formatValue(e.name,t)+"</div>";else if(e.street){var n=e.street;e.housenumber&&(n=formatTools.insComma(n,e.housenumber)),o+="<div class='nameseg'>"+formatTools.formatValue(n,t)+"</div>"}var a="";return e.postcode&&(a=e.postcode),e.city&&(a=formatTools.insComma(a,e.city)),e.country&&(a=formatTools.insComma(a,e.country)),a&&(o+="<div class='cityseg'>"+formatTools.formatValue(a,t)+"</div>"),"highway"===e.osm_key,o+="place"===e.osm_key?"<span class='moreseg'>"+e.osm_value+"</span>":"<span class='moreseg'>"+e.osm_key+"</span>"},dataToText=function(e){var t="";return e.name?t=e.name:e.street&&(t=e.street,e.housenumber&&(t=formatTools.insComma(t,e.housenumber))),e.postcode&&(t=formatTools.insComma(t,e.postcode)),e.city&&t.indexOf(e.city)<0&&(t=formatTools.insComma(t,e.city)),e.country&&t.indexOf(e.country)<0&&(t=formatTools.insComma(t,e.country)),t},AutoComplete=function(e,t){this.host=e,this.key=t,this.dataType="json",this.api_params={locale:"en"}};AutoComplete.prototype.createPath=function(e){for(var t in this.api_params){var o=this.api_params[t];if("[object Object]"!==o.toString())if(GHRoute.isArray(o))for(var n in o)e+="&"+encodeURIComponent(t)+"="+encodeURIComponent(o[n]);else e+="&"+encodeURIComponent(t)+"="+encodeURIComponent(o);else for(var a in o)e+="&"+encodeURIComponent(t)+"."+encodeURIComponent(a)+"="+encodeURIComponent(o[a])}return e},AutoComplete.prototype.createGeocodeURL=function(e,t){var o=this.createPath(this.host+"/geocode?limit=6&type="+this.dataType+"&key="+this.key);if(t>=0&&t<e.route.size()){var n=e.route.getIndex(t);n.isResolved()&&(o+="&point="+n.lat+","+n.lng)}return o},AutoComplete.prototype.getAutoCompleteDiv=function(e){return $("#locationpoints > div.pointDiv").eq(e).find(".pointInput")},AutoComplete.prototype.hide=function(){$(':input[id$="_Input"]').autocomplete().hide()},AutoComplete.prototype.showListForIndex=function(e,t,o){var n=this.getAutoCompleteDiv(o),a=this.createGeocodeURL(e,o-1),r={containerClass:"autocomplete",timeout:1e3,deferRequestBy:5,minChars:2,maxHeight:510,noCache:!0,triggerSelectOnValidInput:!1,autoSelectFirst:!1,paramName:"q",dataType:e.dataType,onSearchStart:function(e){var t=new GHInput(e.q).lat;return void 0===t},serviceUrl:function(){return a},transformResult:function(e,t){if(e.suggestions=[],e.hits)for(var o=0;o<e.hits.length;o++){var n=e.hits[o];e.suggestions.push({value:dataToText(n),data:n})}return e},onSearchError:function(e,t,o,n,a){},formatResult:function(e,t){return dataToHtml(e.data,t)},onSelect:function(e){r.onPreSelect(e)},onPreSelect:function(a){var r=e.route.getIndex(o);n.autocomplete().disable();var s=a.data.point;r.setCoord(s.lat,s.lng),r.input=a.value,t(!0)||mapLayer.focus(r,15,o),n.autocomplete().enable()}};n.autocomplete(r)},AutoComplete.prototype.createStub=function(){return complete=new AutoComplete,complete.showListForIndex=function(){},complete.hide=function(){},complete},AutoComplete.prototype.setLocale=function(e){e&&(this.api_params.locale=e)},module.exports=AutoComplete;

},{"./graphhopper/GHInput.js":5,"./graphhopper/GHRoute.js":7,"./map.js":18,"./tools/format.js":23}],2:[function(require,module,exports){
exports.options={environment:"development",routing:{host:"http://localhost:8989"},geocoding:{host:"http://localhost:8989"},thunderforest:{api_key:""}};

},{}],3:[function(require,module,exports){
function addVectorLayer(e,t){stylejsonObj.sources.mapbox.tiles[0]=t,stylejsonObj.sprite="http://"+host+":8989/assets/bright-v8",stylejsonObj.glyphs="http://"+host+":8989/assets/font/{fontstack}/{range}.pbf",styleTileURL[e]=t;var a=L.mapboxGL({attribution:osmAttr+" © <a href='https://www.mapbox.com/about/maps/'>Mapbox</a>",pitch:.01,style:stylejsonObj});availableVectorTileLayers[e]=a,lastlayerName=localStorage.lastlayerName,void 0===lastlayerName&&(lastlayerName=e),e===lastlayerName&&(module.exports.activeLayerName=e,module.exports.defaultLayer=a,module.exports.activeLayer=a)}var ghenv=require("./options.js").options,tfAddition="";ghenv.thunderforest.api_key&&(tfAddition="?apikey="+ghenv.thunderforest.api_key);var osmAttr='&copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap</a> contributors',retinaTiles=L.Browser.retina,host,mapBox=require("../leaflet-mapbox-gl.js"),lyrk=L.tileLayer("https://tiles.lyrk.org/"+(retinaTiles?"lr":"ls")+"/{z}/{x}/{y}?apikey=6e8cfef737a140e2a58c8122aaa26077",{attribution:osmAttr+', <a href="https://geodienste.lyrk.de/">Lyrk</a>'}),omniscale=L.tileLayer.wms("https://maps.omniscale.net/v1/mapsgraph-bf48cc0b/tile",{layers:"osm",attribution:osmAttr+', &copy; <a href="http://maps.omniscale.com/">Omniscale</a>'}),openMapSurfer=L.tileLayer("http://korona.geog.uni-heidelberg.de/tiles/roads/x={x}&y={y}&z={z}",{attribution:osmAttr+', <a href="http://korona.geog.uni-heidelberg.de/contact.html">GIScience Heidelberg</a>'}),sorbianLang=L.tileLayer("http://map.dgpsonline.eu/osmsb/{z}/{x}/{y}.png",{attribution:osmAttr+', <a href="http://www.alberding.eu/">&copy; Alberding GmbH, CC-BY-SA</a>'}),thunderTransport=L.tileLayer("https://{s}.tile.thunderforest.com/transport/{z}/{x}/{y}.png"+tfAddition,{attribution:osmAttr+', <a href="http://www.thunderforest.com/transport/" target="_blank">Thunderforest Transport</a>'}),thunderCycle=L.tileLayer("https://{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png"+tfAddition,{attribution:osmAttr+', <a href="http://www.thunderforest.com/opencyclemap/" target="_blank">Thunderforest Cycle</a>'}),thunderOutdoors=L.tileLayer("https://{s}.tile.thunderforest.com/outdoors/{z}/{x}/{y}.png"+tfAddition,{attribution:osmAttr+', <a href="http://www.thunderforest.com/outdoors/" target="_blank">Thunderforest Outdoors</a>'}),wrk=L.tileLayer("http://{s}.wanderreitkarte.de/topo/{z}/{x}/{y}.png",{attribution:osmAttr+', <a href="http://wanderreitkarte.de" target="_blank">WanderReitKarte</a>',subdomains:["topo4","topo","topo2","topo3"]}),osm=L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:osmAttr}),osmde=L.tileLayer("http://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png",{attribution:osmAttr}),mapLink='<a href="http://www.esri.com/">Esri</a>',wholink="i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community",esriAerial=L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:"&copy; "+mapLink+", "+wholink,maxZoom:18}),availableTileLayers={Omniscale:omniscale,OpenStreetMap:osm,"Esri Aerial":esriAerial,"TF Transport":thunderTransport,"TF Cycle":thunderCycle,"TF Outdoors":thunderOutdoors,Lyrk:lyrk,WanderReitKarte:wrk,OpenMapSurfer:openMapSurfer,"Sorbian Language":sorbianLang,"OpenStreetMap.de":osmde};module.exports.activeLayerName="Omniscale",module.exports.defaultLayer=omniscale,module.exports.activeLayer=module.exports.defaultLayer;var availableRasterTileLayers={},availableVectorTileLayers={};availableRasterTileLayers.Omniscale=omniscale,availableRasterTileLayers["Esri Aerial"]=esriAerial,availableRasterTileLayers.OpenMapSurfer=openMapSurfer,availableRasterTileLayers["TF Transport"]=thunderTransport,availableRasterTileLayers["TF Cycle"]=thunderCycle,availableRasterTileLayers["TF Outdoors"]=thunderOutdoors,availableRasterTileLayers.WanderReitKarte=wrk,availableRasterTileLayers.OpenStreetMap=osm,availableRasterTileLayers["OpenStreetMap.de"]=osmde,availableRasterTileLayers["Sorbian Language"]=sorbianLang,module.exports.getAvailableTileLayers=function(){return $.extend(availableVectorTileLayers,availableRasterTileLayers)};var styleTileURL={};module.exports.setActivelayer=function(e){styleTileURL[e.name]&&(e.layer.options.style.sources.mapbox.tiles[0]=styleTileURL[e.name],module.exports.activeLayer=availableVectorTileLayers[e.name],localStorage.lastlayerName=e.name)},module.exports.selectLayer=function(e){var t=availableRasterTileLayers[e];if(!t){t=module.exports.defaultLayer;try{t.options.style.sources.mapbox.tiles[0]=styleTileURL[module.exports.activeLayerName]}catch(a){}}return t};var stylejsonObj=require("../../vectorstyles/bright-v9.json");module.exports.setHost=function(e){host=e,""===e&&(host="localhost"),console.log("tileLayers module.exports.setHost host="+host+" hostname="+e),mapboxgl.supported()&&addVectorLayer("Osm2VectorTiles.org","http://osm2vectortiles-0.tileserver.com/v2/{z}/{x}/{y}.pbf"),$.getJSON("http://"+host+":3000/mbtilesareas.json",function(e){var t=0;mapboxgl.supported()?$.each(e,function(e,a){var r="Vector "+a.country.charAt(0).toUpperCase()+a.country.slice(1),o="http://"+host+":3000/"+a.country+"/{z}/{x}/{y}.pbf";addVectorLayer(r,o),t++}):alert("Your browser does not support Mapbox GL")})};

},{"../../vectorstyles/bright-v9.json":32,"../leaflet-mapbox-gl.js":10,"./options.js":2}],4:[function(require,module,exports){
...
var GHRoute=require("./GHRoute.js"),GHInput=require("./GHInput.js"),graphhopperTools=require("./tools.js");Function.prototype.bind||(Function.prototype.bind=function(t){if("function"!=typeof this)throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");var e=Array.prototype.slice.call(arguments,1),i=this,o=function(){},s=function(){return i.apply(this instanceof o&&t?this:t,e.concat(Array.prototype.slice.call(arguments)))};return o.prototype=this.prototype,s.prototype=new o,s});var GHRequest=function(t,e){this.host=t,this.key=e,this.route=new GHRoute(new GHInput,new GHInput),this.from=this.route.first(),this.to=this.route.last(),this.features={},this.do_zoom=!0,this.useMiles=!1,this.dataType="json",this.api_params={locale:"en",vehicle:"car",weighting:"fastest",elevation:!1,ascendAvoidance:0,niceLevel:3,algorithm:"",alternative_route:{max_paths:1},round_trip:{distance:0},heading:180},this.route.addListener("route.add",function(t){this.to=this.route.last()}.bind(this)),this.route.addListener("route.remove",function(t){this.from=this.route.first(),this.to=this.route.last()}.bind(this)),this.route.addListener("route.move",function(t){this.from=this.route.first(),this.to=this.route.last()}.bind(this)),this.route.addListener("route.reverse",function(t){this.from=this.route.first(),this.to=this.route.last()}.bind(this))};GHRequest.prototype.init=function(t){for(var e in t){var i=t[e];"false"===i?i=!1:"true"===i&&(i=!0),"point"!==e&&"mathRandom"!==e&&"do_zoom"!==e&&"layer"!==e&&"use_miles"!==e&&-1===e.indexOf(".")&&(this.api_params[e]=i)}"do_zoom"in t&&(this.do_zoom=t.do_zoom),"use_miles"in t&&(this.useMiles=t.use_miles),this.api_params.elevation=!1;var o=this.features[this.api_params.vehicle];if(o&&o.elevation&&("elevation"in t?this.api_params.elevation=t.elevation:this.api_params.elevation=!0),this.api_params.CHEnabled=!1,o&&o.CHEnabled&&("CHEnabled"in t?this.api_params.CHEnabled=t.CHEnabled:this.api_params.CHEnabled=!0),t.q){var s=t.q;t.point||(t.point=[]);var a=s.indexOf("from:"),n=s.indexOf("to:");if(a>=0&&n>=0)n>a?(t.point.push(s.substring(a+5,n).trim()),t.point.push(s.substring(n+3).trim())):(t.point.push(s.substring(n+3,a).trim()),t.point.push(s.substring(a+5).trim()));else for(var r=s.split("p:"),p=0;p<r.length;p++){var h=r[p].trim();0!==h.length&&t.point.push(h)}}},GHRequest.prototype.initVehicle=function(t){this.api_params.vehicle=t;var e=this.features[t];e&&!e.CHEnabled?(this.api_params.CHEnabled=!1,$("#niceLevelcontrol").show(),$("#niceLevelcontrol").css("visibility","visible"),$("#alternativeRoutecontrol").show(),$("#alternativeRoutecontrol").css("visibility","visible"),$("#roundtripcontrol").show(),$("#roundtripcontrol").css("visibility","visible"),$("#roundtripdistance").show(),$("#roundtripdistance").css("visibility","visible")):this.api_params.CHEnabled=!0,e&&e.elevation?(this.api_params.elevation=!0,this.api_params.CHEnabled||($("#ascendcontrol").show(),$("#ascendcontrol").css("visibility","visible"))):this.api_params.elevation=!1},GHRequest.prototype.hasCHEnabled=function(){return this.api_params.CHEnabled},GHRequest.prototype.hasElevation=function(){return this.api_params.elevation},GHRequest.prototype.getVehicle=function(){return this.api_params.vehicle},GHRequest.prototype.createGeocodeURL=function(t,e){var i=this.host;t&&(i=t);var o=this.createPath(i+"/geocode?limit=6&type="+this.dataType+"&key="+this.key);if(e>=0&&e<this.route.size()){var s=this.route.getIndex(e);s.isResolved()&&(o+="&point="+s.lat+","+s.lng)}return o},GHRequest.prototype.createURL=function(){return this.createPath(this.host+"/route?"+this.createPointParams(!1)+"&type="+this.dataType+"&key="+this.key)},GHRequest.prototype.createGPXURL=function(t,e,i){return this.createPath(this.host+"/route?"+this.createPointParams(!1)+"&type=gpx&key="+this.key+"&gpx.route="+t+"&gpx.track="+e+"&gpx.waypoints="+i)},GHRequest.prototype.createHistoryURL=function(){return this.createPath("?"+this.createPointParams(!0))+"&use_miles="+!!this.useMiles},GHRequest.prototype.createPointParams=function(t){var e,i,o,s="";for(i=0,o=this.route.size();o>i;i++)e=this.route.getIndex(i),i>0&&(s+="&"),s+=t?"point="+encodeURIComponent(e.input):"point="+encodeURIComponent(e.toString());return s},GHRequest.prototype.createPath=function(t){for(var e in this.api_params){var i=this.api_params[e];if("[object Object]"!==i.toString())if(GHRoute.isArray(i))for(var o in i)t+="&"+encodeURIComponent(e)+"="+encodeURIComponent(i[o]);else t+="&"+encodeURIComponent(e)+"="+encodeURIComponent(i);else for(var s in i)t+="&"+encodeURIComponent(e)+"."+encodeURIComponent(s)+"="+encodeURIComponent(i[s])}return t},GHRequest.prototype.doRequest=function(t,e){var i=this;$.ajax({timeout:3e4,url:t,success:function(t){if(t.paths)for(var o=0;o<t.paths.length;o++){var s=t.paths[o];if(s.points_encoded){var a=graphhopperTools.decodePath(s.points,i.hasElevation());s.points={type:"LineString",coordinates:a};var n=graphhopperTools.decodePath(s.snapped_waypoints,i.hasElevation());s.snapped_waypoints={type:"MultiPoint",coordinates:n}}}e(t)},error:function(i){var o,s="API did not respond! ";if(i&&i.responseText&&i.responseText.indexOf("{")>=0)o=JSON.parse(i.responseText);else if(i&&i.statusText&&"OK"!==i.statusText){s+=i.statusText;var a="Error for "+t;o={message:s,hints:[{message:s,details:a}]}}console.log(s+" "+JSON.stringify(i)),e(o)},type:"GET",dataType:this.dataType,crossDomain:!0})},GHRequest.prototype.getInfo=function(){var t=this.host+"/info?type="+this.dataType+"&key="+this.key;return $.ajax({url:t,timeout:3e3,type:"GET",dataType:this.dataType,crossDomain:!0})},GHRequest.prototype.setLocale=function(t){t&&(this.api_params.locale=t)},GHRequest.prototype.fetchTranslationMap=function(t){t||(t=""),console.log("GHRequest.prototype.fetchTranslationMap host="+this.host),void 0===this.host&&(this.host="http://localhost:8989");var e="";if(void 0!==this.key)var e="&key="+this.key;var i=this.host+"/i18n/"+t+"?type="+this.dataType+e;return $.ajax({url:i,timeout:3e3,type:"GET",dataType:this.dataType,crossDomain:!0})},module.exports=GHRequest;

},{"./GHInput.js":5,"./GHRoute.js":7,"./tools.js":8}],7:[function(require,module,exports){
...
},{"./GHInput.js":5}],8:[function(require,module,exports){
...
},{"./messages.js":20,"./translate.js":27}],10:[function(require,module,exports){
L.MapboxGL=L.Class.extend({initialize:function(t){L.setOptions(this,t)},onAdd:function(t){this._map=t,this._glContainer||this._initContainer(),t._panes.tilePane.appendChild(this._glContainer),t.on("zoomanim",this._animateZoom,this),t.on("move",this._update,this),this._initGL()},onRemove:function(t){t.getPanes().tilePane.removeChild(this._glContainer),t.off("zoomanim",this._animateZoom,this),t.off("move",this._update,this),t.attributionControl.removeAttribution(this.options.attribution),this._glMap.remove(),this._glMap=null},addTo:function(t){return t.addLayer(this),this},_initContainer:function(){var t=this._glContainer=L.DomUtil.create("div","leaflet-gl-layer"),i=this._map.getSize();t.style.width=i.x+"px",t.style.height=i.y+"px"},_initGL:function(){var t=this._map.getCenter(),i=L.extend({},this.options,{container:this._glContainer,interactive:!1,center:[t.lng,t.lat],zoom:this._map.getZoom()-1,attributionControl:!0});this._glMap=new mapboxgl.Map(i),this._glMap.transform.latRange=null,this._map.attributionControl.addAttribution(this.options.attribution)},_update:function(){var t=this._map.getSize(),i=this._glContainer,n=this._glMap,o=this._map.containerPointToLayerPoint([0,0]);L.DomUtil.setPosition(i,o);var e=this._map.getCenter(),a=n.transform;a.center=mapboxgl.LngLat.convert([e.lng,e.lat]),a.zoom=this._map.getZoom()-1,n.transform.width!==t.x||n.transform.height!==t.y?(i.style.width=t.x+"px",i.style.height=t.y+"px",n.resize()):n._update()},_animateZoom:function(t){var i=t.origin.add(this._map._getMapPanePos()).subtract(this._map.getSize().divideBy(2));this._glMap.zoomTo(t.zoom-1,{duration:250,offset:[i.x,i.y]})}}),L.mapboxGL=function(t){return new L.MapboxGL(t)};
...
(function (global){
function initFromParams(e,t){ghRequest.init(e);var a,r=0;if(e.point)for(var o=0;o<e.point.length;o++)""!==e.point[o]&&(r++,a=o);var n=e.point&&r>=2;n?resolveCoords(e.point,t):e.point&&1===r&&(ghRequest.route.set(e.point[a],a,!0),resolveIndex(a).done(function(){mapLayer.focus(ghRequest.route.getIndex(a),15,a)}))}function resolveCoords(e,t){for(var a=0,r=e.length;r>a;a++){var o=e[a],n=ghRequest.route.getIndex(a);n&&o===n.input&&n.isResolved()||ghRequest.route.set(o,a,!0)}checkInput(),ghRequest.route.isResolved()?(resolveAll(),routeLatLng(ghRequest,t)):$.when.apply($,resolveAll()).done(function(){routeLatLng(ghRequest,t)})}function getToFrom(e){return 0===e?FROM:e===ghRequest.route.size()-1?TO:-1}function checkInput(){var e=$("#pointTemplate").html(),t=ghRequest.route.size();$("#locationpoints > div.pointDiv").length>t&&$("#locationpoints > div.pointDiv:gt("+(t-1)+")").remove(),$("#locationpoints .pointDelete").off();for(var a=function(){var e=$(this).parent().data("index");ghRequest.route.removeSingle(e),mapLayer.clearLayers(),routeLatLng(ghRequest,!1)},r=0;t>r;r++){var o=$("#locationpoints > div.pointDiv").eq(r);0===o.length&&($("#locationpoints > div.pointAdd").before(translate.nanoTemplate(e,{id:r})),o=$("#locationpoints > div.pointDiv").eq(r));var n=getToFrom(r);if(o.data("index",r),o.find(".pointFlag").attr("src",n===FROM?"./img/marker-small-green.png":n===TO?"./img/marker-small-red.png":"./img/marker-small-blue.png"),t>2?o.find(".pointDelete").click(a).prop("disabled",!1).removeClass("ui-state-disabled"):o.find(".pointDelete").prop("disabled",!0).addClass("ui-state-disabled"),autocomplete.showListForIndex(ghRequest,routeIfAllResolved,r),translate.isI18nIsInitialized()){var i=o.find(".pointInput");0===r?$(i).attr("placeholder",translate.tr("from_hint")):r===t-1?$(i).attr("placeholder",translate.tr("to_hint")):$(i).attr("placeholder",translate.tr("via_hint"))}}}function setToStart(e){var t=e.target.getLatLng(),a=ghRequest.route.getIndexByCoord(t);ghRequest.route.move(a,0),routeIfAllResolved()}function setToEnd(e){var t=e.target.getLatLng(),a=ghRequest.route.getIndexByCoord(t);ghRequest.route.move(a,-1),routeIfAllResolved()}function setStartCoord(e){ghRequest.route.set(e.latlng.wrap(),0),resolveFrom(),routeIfAllResolved()}function setIntermediateCoord(e){var t=mapLayer.getSubLayers("route"),a=t.map(function(e){return{coordinates:e.getLatLngs(),wayPoints:e.feature.properties.snapped_waypoints.coordinates.map(function(e){return L.latLng(e[1],e[0])})}}),r=routeManipulation.getIntermediatePointIndex(a,e.latlng);ghRequest.route.add(e.latlng.wrap(),r),resolveIndex(r),routeIfAllResolved()}function deleteCoord(e){var t=e.target.getLatLng();ghRequest.route.removeSingle(t),mapLayer.clearLayers(),routeLatLng(ghRequest,!1)}function setEndCoord(e){var t=ghRequest.route.size()-1;ghRequest.route.set(e.latlng.wrap(),t),resolveTo(),routeIfAllResolved()}function routeIfAllResolved(e){return ghRequest.route.isResolved()?(routeLatLng(ghRequest,e),!0):!1}function setFlag(e,t){if(e.lat){var a=getToFrom(t),r=mapLayer.createMarker(t,e,setToEnd,setToStart,deleteCoord,ghRequest);r._openPopup=r.openPopup,r.openPopup=function(){var e,t=this.getLatLng(),a=ghRequest.route.getIndexFromCoord(t);if(a.resolvedList&&a.resolvedList[0]&&a.resolvedList[0].locationDetails){var r=a.resolvedList[0].locationDetails;e=format.formatAddress(r),this._popup.setContent(e).update()}this._openPopup()};var o={text:translate.tr("set_start"),callback:setToStart,index:1,state:2};-1===a&&r.options.contextmenuItems.push(o),r.on("dragend",function(e){mapLayer.clearLayers();var a=e.target.getLatLng();autocomplete.hide(),ghRequest.route.getIndex(t).setCoord(a.lat,a.lng),resolveIndex(t),ghRequest.do_zoom=!1,routeLatLng(ghRequest,!1)})}}function resolveFrom(){return resolveIndex(0)}function resolveTo(){return resolveIndex(ghRequest.route.size()-1)}function resolveIndex(e){return setFlag(ghRequest.route.getIndex(e),e),0===e?ghRequest.to.isResolved()?mapLayer.setDisabledForMapsContextMenu("start",!1):mapLayer.setDisabledForMapsContextMenu("start",!0):e===ghRequest.route.size()-1&&(ghRequest.from.isResolved()?mapLayer.setDisabledForMapsContextMenu("end",!1):mapLayer.setDisabledForMapsContextMenu("end",!0)),nominatim.resolve(e,ghRequest.route.getIndex(e))}function resolveAll(){for(var e=[],t=0,a=ghRequest.route.size();a>t;t++)e[t]=resolveIndex(t);return e}function flagAll(){for(var e=0,t=ghRequest.route.size();t>e;e++)setFlag(ghRequest.route.getIndex(e),e)}function routeLatLng(e,t){var a=e.do_zoom;e.do_zoom=!0;var r=e.createHistoryURL()+"&layer="+tileLayers.activeLayerName;if(!t&&History.enabled){var o=urlTools.parseUrl(r);return console.log(o),o.do_zoom=a,o.mathRandom=Math.random(),void History.pushState(o,messages.browserTitle,r)}var n=$("#info");n.empty(),n.show();var i=$("<div class='route_results'/>");n.append(i),mapLayer.clearElevation(),mapLayer.clearLayers(),flagAll(),mapLayer.setDisabledForMapsContextMenu("intermediate",!1),$("#vehicles button").removeClass("selectvehicle"),$("button#"+e.getVehicle().toLowerCase()).addClass("selectvehicle");var s=e.createURL();i.html('<img src="img/indicator.gif"/> Search Route ...'),e.doRequest(s,function(t){function o(e,t,a,r,o,n){return function(){var s=e[t];mapLayer.eachLayer(function(e){if(e.setStyle){var t=e.feature===s;e.setStyle(t?d:c),t&&(L.Browser.ie||L.Browser.opera||e.bringToFront())}}),o&&(mapLayer.clearElevation(),mapLayer.addElevation(s,n)),l.find("li").removeClass("current"),i.find("div").removeClass("current"),a.addClass("current"),r.addClass("current")}}if(i.html(""),t.message){var n=t.message;if(console.log(n),t.hints)for(var s=0;s<t.hints.length;s++)i.append("<div class='error'>"+t.hints[s].message+"</div>");else i.append("<div class='error'>"+n+"</div>")}else{var l=$("<ul id='route_result_tabs'/>");t.paths.length>1&&(i.append(l),i.append("<div class='clear'/>"));for(var u,p={color:"#00cc33",weight:5,opacity:.6},d={color:"#00cc33",weight:6,opacity:.8},c={color:"darkgray",weight:6,opacity:.8},g=[],h=0;h<t.paths.length;h++){var v=$("<li>").append(h+1+"<img class='alt_route_img' src='./img/alt_route.png'/>");0===h&&(u=v),l.append(v);var m=t.paths[h],f=0===h?p:c,q={type:"Feature",geometry:m.points,properties:{style:f,name:"route",snapped_waypoints:m.snapped_waypoints}};g.push(q),mapLayer.addDataToRoutingLayer(q);var y=$("<div class='route_result_tab'>");i.append(y),v.click(o(g,h,v,y,e.hasElevation(),e.useMiles));var R=translate.createTimeString(m.time),b=translate.createDistanceString(m.distance,e.useMiles),x="";"yes"===m.haswaytypeinfo&&(0!==m.unpavedDistance&&(x+="<br/>Unpaved:"+translate.createDistanceString(m.unpavedDistance,e.useMiles)),0!==m.cyclewayDistance&&(x+="<br/>Cycleway:"+translate.createDistanceString(m.cyclewayDistance,e.useMiles)),0!==m.pushingSectionDistance&&(x+="<br/>Pushing:"+translate.createDistanceString(m.pushingSectionDistance,e.useMiles)),0!==m.roadDistance&&(x+="<br/>Road:"+translate.createDistanceString(m.roadDistance,e.useMiles)),0!==m.unspecificWayDistance&&(x+="<br/>Unspecific:"+translate.createDistanceString(m.unspecificWayDistance,e.useMiles)));var _=$("<div class='route_description'>");m.description&&m.description.length>0&&(_.text(m.description),_.append("<br/>")),_.append(translate.tr("route_info",[b,R]));var I=function(e){return function(){mapLayer.updateScale(e),ghRequest.useMiles=e,resolveAll(),routeLatLng(ghRequest)}},D=$("<button class='plain_text_button "+(e.useMiles?"gray":"")+"'>");D.text(translate.tr2("km_abbr")),D.click(I(!1));var w=$("<button class='plain_text_button "+(e.useMiles?"":"gray")+"'>");w.text(translate.tr2("mi_abbr")),w.click(I(!0));var S=$("<span style='float: right;'>");if(S.append(D),S.append("|"),S.append(w),_.append(S),e.hasElevation()&&_.append(translate.createEleInfoString(m.ascend,m.descend,e.useMiles)),_.append(x),y.append(_),m.instructions){var M=require("./instructions.js");y.append(M.create(mapLayer,m,r,e))}}u.click(),mapLayer.adjustMapSize();var C=t.paths[0];if(C.bbox&&a){var T=C.bbox[0],j=C.bbox[1],k=C.bbox[2],F=C.bbox[3],A=new L.LatLngBounds(new L.LatLng(j,T),new L.LatLng(F,k));mapLayer.fitMapToBounds(A)}$(".defaulting").each(function(e,t){$(t).css("color","black")})}})}function graphHopperSubmit(){var e,t,a,r=[],o=!0,n=$("#locationpoints > div.pointDiv > input.pointInput"),i=n.size;return $.each(n,function(n){0===n?(e=$(this).val(),e!==translate.tr("from_hint")&&""!==e?r.push(e):o=!1):n===i-1?(t=$(this).val(),t!==translate.tr("to_hint")&&""!==t?r.push(t):o=!1):(a=$(this).val(),a!==translate.tr("via_hint")&&""!==a?r.push(a):o=!1)}),o&&e!==translate.tr("from_hint")?t===translate.tr("to_hint")?(ghRequest.from.setStr(e),void $.when(resolveFrom()).done(function(){mapLayer.focus(ghRequest.from,null,0)})):void(o&&resolveCoords(r)):void 0}function tripSubmit(){$("#tripDiv").hide(),$("#changeTripButton").hide(),$("#addTripButton").hide(),$("#routingOptions").show()}function isProduction(){return host.indexOf("graphhopper.com")>0}var menu=require("./menu.js");global.d3=require("d3");var L=require("leaflet");require("leaflet-loading"),require("./lib/leaflet.contextmenu.js"),require("./lib/leaflet.elevation-0.0.4.min.js"),require("./lib/leaflet_numbered_markers.js"),global.jQuery=require("jquery"),global.$=global.jQuery,require("./lib/jquery-ui-custom-1.12.0.min.js"),require("./lib/jquery.history.js"),require("./lib/jquery.autocomplete.js");var mathTools=require("./tools/math.js"),ghenv=require("./config/options.js").options;console.log("Environment="+ghenv.environment);var GHInput=require("./graphhopper/GHInput.js"),GHRequest=require("./graphhopper/GHRequest.js"),host=ghenv.routing.host;host||(host=""===location.port?location.protocol+"//"+location.hostname:location.protocol+"//"+location.hostname+":"+location.port);var AutoComplete=require("./autocomplete.js");if("development"===ghenv.environment)var autocomplete=AutoComplete.prototype.createStub();else var autocomplete=new AutoComplete(ghenv.geocoding.host,ghenv.geocoding.api_key);var mapLayer=require("./map.js"),nominatim=require("./nominatim.js"),routeManipulation=require("./routeManipulation.js"),gpxExport=require("./gpxexport.js"),messages=require("./messages.js"),translate=require("./translate.js"),format=require("./tools/format.js"),urlTools=require("./tools/url.js"),vehicle=require("./tools/vehicle.js"),tileLayers=require("./config/tileLayers.js");tileLayers.setHost("localhost");var debug=!1,ghRequest=new GHRequest(host,ghenv.routing.api_key),bounds={},metaVersionInfo;global.window&&(window.log=function(){log.history=log.history||[],log.history.push(arguments),this.console&&debug&&console.log(Array.prototype.slice.call(arguments))}),$(document).ready(function(e){jQuery.support.cors=!0,gpxExport.addGpxExport(ghRequest),isProduction()&&$("#hosting").show();var t=window.History;t.enabled&&t.Adapter.bind(window,"statechange",function(){var e=t.getState();console.log(e),initFromParams(e.data,!0)}),$("#locationform").submit(function(e){e.preventDefault(),graphHopperSubmit()}),$("#tripForm").submit(function(e){e.preventDefault(),tripSubmit()}),last_id=localStorage.last_id,void 0===last_id&&(last_id=100),$("#addTripButton").click(function(e){e.preventDefault();var t=$("#tripTree");last_id+=1;var a=t.tree("getNodeById",1);t.tree("appendNode",{name:"new_node "+last_id,id:last_id},a),localStorage.tripData=t.tree("toJson"),localStorage.last_id=last_id}),$("#saveTripButton").click(function(e){e.preventDefault(),$("#tripDiv").show(),$("#changeTripButton").show(),$("#addTripButton").show(),$(".route_result_tab").hide(),$("#routingOptions").hide()});var a=urlTools.parseUrlWithHisto();$.when(ghRequest.fetchTranslationMap(a.locale),ghRequest.getInfo()).then(function(e,t){function r(e,t){var a=$("<button class='vehicle-btn' title='"+translate.tr(e)+"'/>");return t&&a.hide(),a.attr("id",e),a.html("<img src='./img/"+e+".png' alt='"+translate.tr(e)+"'></img>"),a.click(function(){ghRequest.initVehicle(e),resolveAll(),routeLatLng(ghRequest)}),a}var o=e[0];autocomplete.setLocale(o.locale),ghRequest.setLocale(o.locale),translate.init(o);var n=t[0],i=n.bbox;bounds.initialized=!0,bounds.minLon=i[0],bounds.minLat=i[1],bounds.maxLon=i[2],bounds.maxLat=i[3],nominatim.setBounds(bounds);var s=$("#vehicles");if(n.features){ghRequest.features=n.features;var l={car:1,foot:2,bike:3,motorcycle:1e4},u=a.vehicle&&(!l[a.vehicle]||l[a.vehicle]>3),p=vehicle.getSortedVehicleKeys(n.features,l);p.length>0&&ghRequest.initVehicle(p[0]);var d=[];for(var c in p){var g=r(p[c].toLowerCase(),!u&&c>2);s.append(g),c>2&&d.push(g)}if(!u&&p.length>3){var h=$("<a id='more-vehicle-btn'> ...</a>").click(function(){h.hide();for(var e in d)d[e].show()});s.append($("<a class='vehicle-info-link' href='https://graphhopper.com/api/1/docs/supported-vehicle-profiles/'>?</a>")),s.append(h)}}metaVersionInfo=messages.extractMetaVersionInfo(n),setTimeout(function(){console.log("Calling delayed initMap1 with urlParams.layer:"+a.layer),mapLayer.initMap(bounds,setStartCoord,setIntermediateCoord,setEndCoord,a.layer)},100),setTimeout(function(){initFromParams(a,!0)},100),checkInput()},function(e){console.log(e),$("#error").html('GraphHopper API offline? <a href="http://graphhopper.com/maps">Refresh</a><br/>Status: '+e.statusText+"<br/>host="+host),bounds={minLon:-180,minLat:-90,maxLon:180,maxLat:90},nominatim.setBounds(bounds),mapLayer.initMap(bounds,setStartCoord,setIntermediateCoord,setEndCoord)}),$(window).resize(function(){mapLayer.adjustMapSize()}),$("#locationpoints").sortable({items:".pointDiv",cursor:"n-resize",containment:"parent",handle:".pointFlag",update:function(e,t){var a=$(t.item[0]).data("index");sortable_items=$("#locationpoints > div.pointDiv"),$(sortable_items).each(function(e){var t=$(this).data("index");return a===t?(ghRequest.route.move(t,e),routeIfAllResolved()||checkInput(),!1):void 0})}}),$("#locationpoints > div.pointAdd").click(function(){ghRequest.route.add(new GHInput),checkInput()}),checkInput()});var FROM="from",TO="to";$(function(){$("#slider-range-ascend").slider({range:"max",min:-1,max:1,step:.1,slide:function(e,t){$("#ascendAvoidance").val(t.value),ghRequest.api_params.ascendAvoidance=t.value,ghRequest.api_params.weighting="elevation",routeLatLng(ghRequest,!1)}}),$("#ascendAvoidance").val($("#slider-range-ascend").slider("value"))}),$(function(){var e=[.25,1/3.5,1/3,.4,.5,1/1.5,1,1.5,2,2.5,3,3.5,4];$("#slider-range-niceLevel").slider({range:"max",min:0,value:6,max:12,step:1,slide:function(t,a){$("#niceLevel").val(a.value),ghRequest.api_params.niceLevel=e[a.value],routeLatLng(ghRequest,!1)}}),$("#niceLevel").val($("#slider-range-niceLevel").slider("value"))}),$(function(){$("#roundtripdistance").spinner({min:0,step:10,change:function(e,t){$(this).spinner("value")>0&&(ghRequest.api_params.algorithm="roundTrip",ghRequest.api_params.round_trip.distance=1e3*$(this).spinner("value"))}})}),$(function(){$("#roundtripheading").spinner({min:0,max:360,step:20,change:function(e,t){$(this).spinner("value")>0&&(ghRequest.api_params.algorithm="roundTrip",ghRequest.api_params.heading=$(this).spinner("value"))}})}),$(function(){$("#slider-range-alternativeRoutesMaxPaths").slider({range:"max",min:1,max:5,step:1,slide:function(e,t){$("#alternativeRoutesMaxPaths").val(t.value),t.value>1?(ghRequest.api_params.algorithm="alternativeRoute",ghRequest.api_params.alternative_route.max_paths=t.value):ghRequest.api_params.algorithm="",routeLatLng(ghRequest,!1)}}),$("#alternativeRoutesMaxPaths").val($("#slider-range-alternativeRoutesMaxPaths").slider("value"))}),module.exports.setFlag=setFlag;var tripData=JSON.parse(localStorage.getItem("tripData"));null===tripData&&(tripData=[{label:"Single tour",id:1,children:[]}],localStorage.tripData=JSON.stringify(tripData)),$(function(){var e=$("#tripTree");e.tree({data:tripData,dragAndDrop:!0,autoOpen:1,onCreateLi:function(e,t){t.find(".jqtree-element").append('<a href="#node-'+e.id+'" class="edit" data-node-id="'+e.id+'"> edit</a>;')},onCanMove:function(e){return!!e.parent.parent}}),e.on("click",".edit",function(t){var a=$(t.target).data("node-id"),r=e.tree("getNodeById",a);r&&alert(r.name)}),e.bind("tree.move",function(t){t.move_info.do_move(),localStorage.tripData=e.tree("toJson")})});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./autocomplete.js":1,"./config/options.js":2,"./config/tileLayers.js":3,"./gpxexport.js":4,"./graphhopper/GHInput.js":5,"./graphhopper/GHRequest.js":6,"./instructions.js":9,"./lib/jquery-ui-custom-1.12.0.min.js":11,"./lib/jquery.autocomplete.js":12,"./lib/jquery.history.js":13,"./lib/leaflet.contextmenu.js":14,"./lib/leaflet.elevation-0.0.4.min.js":15,"./lib/leaflet_numbered_markers.js":16,"./map.js":18,"./menu.js":19,"./messages.js":20,"./nominatim.js":21,"./routeManipulation.js":22,"./tools/format.js":23,"./tools/math.js":24,"./tools/url.js":25,"./tools/vehicle.js":26,"./translate.js":27,"d3":28,"jquery":29,"leaflet":31,"leaflet-loading":30}],18:[function(require,module,exports){
function adjustMapSize(){var e=$("#map"),t=$(window).width()-280;400>t?(t=400,e.attr("style","position: relative; float: right;")):e.attr("style","position: absolute; right: 0;");var a=$(window).height();500>a&&(a=500),e.width(t).height(a),$("#input").height(a);var o=a-60-$("#input_header").height()-$("#footer").height()-$(".route_description").height(),n=$("#route_result_tabs li").height();isNaN(n)||(o-=n),$(".instructions_info").css("max-height",o)}function initMap(e,t,a,o,n){adjustMapSize();var i=tileLayers.selectLayer(n);map=L.map("map",{layers:[i],minZoom:2,contextmenu:!0,contextmenuWidth:150,contextmenuItems:[{separator:!0,index:3,state:["set_default"]},{text:translate.tr("show_coords"),callback:function(e){alert(e.latlng.lat+","+e.latlng.lng)},index:4,state:[1,2,3]},{text:translate.tr("center_map"),callback:function(e){map.panTo(e.latlng)},index:5,state:[1,2,3]}],zoomControl:!1,loadingControl:!1}),addOverlayLayer("Lodging",["poi_lodging","poi_lodging_label"],8),addOverlayLayer("Campsite",["poi_campsites","poi_campsites_label"],8),addOverlayLayer("Bicycle shop",["poi_bicycle_shops","poi_label_bicycle_shops"],8),addOverlayLayer("Alpine hut",["poi_alpine_hut","poi_label_alpine_hut"],8),addOverlayLayer("Hospital",["poi_hospital","poi_label_hospital"],8),addOverlayLayer("Drinking water",["poi_drinking_water"],11),addOverlayLayer("Supermarket",["poi_supermarket"],11),addOverlayLayer("Restaurant",["poi_restaurant"],11),addOverlayLayer("Fast food",["poi_fast_food"],11),addOverlayLayer("Fuel",["poi_fuel"],11);var r={text:translate.tr("set_start"),callback:t,disabled:!1,index:0},l={text:translate.tr("set_intermediate"),callback:a,disabled:!0,index:1},s={text:translate.tr("set_end"),callback:o,disabled:!1,index:2};menuStart=map.contextmenu.insertItem(r,r.index),menuIntermediate=map.contextmenu.insertItem(l,l.index),menuEnd=map.contextmenu.insertItem(s,s.index);var d=new L.Control.Zoom({position:"topleft",zoomInTitle:translate.tr("zoom_in"),zoomOutTitle:translate.tr("zoom_out")}).addTo(map);new L.Control.loading({zoomControl:d}).addTo(map),map.contextmenu.addSet({name:"markers",state:2}),map.contextmenu.addSet({name:"path",state:3}),setTimeout(function(){console.log("Constructing tile layer control"),L.control.layers(tileLayers.getAvailableTileLayers()).addTo(map)},500),map.on("baselayerchange",function(e){e.name&&(tileLayers.activeLayerName=e.name,tileLayers.setActivelayer(e),$("#export-link a").attr("href",function(e,t){return t.replace(/(layer=)([\w\s]+)/,"$1"+tileLayers.activeLayerName)}))}),scaleControl=L.control.scale({imperial:!1}).addTo(map),$("#layerfeatures").hide(),$("#layerfeatures").css("visibility","hidden"),map.on("mousemove",function(e){var t=tileLayers.activeLayer;if(null!==t._glMap&&void 0!==t._glMap){var a=[e.containerPoint.x,e.containerPoint.y],o=t._glMap.queryRenderedFeatures(a,{layers:["poi_lodging","poi_lodging_label","poi_campsites","poi_campsites_label","poi_bicycle_shops","poi_label_bicycle_shops","poi_alpine_hut","poi_label_alpine_hut","poi_hospital","poi_label_hospital"]});if(0!==o.length){$("#layerfeatures").show(),$("#layerfeatures").css("visibility","visible");var n=o[0].properties;delete n.id;var i=JSON.stringify(n,null,1).replace(/{/g,"").replace(/}/g,"");document.getElementById("layerfeatures").innerHTML=i.replace(/\",/g,"").replace(/\"/g,"");var r=.5+1.5*i.split('": "').length;$("#layerfeatures").css("height",r+"em")}else $("#layerfeatures").hide(),$("#layerfeatures").css("visibility","hidden")}}),map.on("zoomend",function(){for(var e=map.getZoom(),t=document.getElementById("layer_menu"),a=0;a<t.childNodes.length;a++)e<t.childNodes[a].minzoom?"disabled"!==t.childNodes[a].className&&(t.childNodes[a].activeClassName=t.childNodes[a].className,t.childNodes[a].className="disabled"):(t.childNodes[a].className=t.childNodes[a].activeClassName,t.childNodes[a].activeClassName=t.childNodes[a].className)}),L.control.scale().addTo(map),map.fitBounds(new L.LatLngBounds(new L.LatLng(e.minLat,e.minLon),new L.LatLng(e.maxLat,e.maxLon))),map.attributionControl.setPrefix("");var m={color:"black",weight:2,opacity:.3},c={type:"Feature",geometry:{type:"LineString",coordinates:[[e.minLon,e.minLat],[e.maxLon,e.minLat],[e.maxLon,e.maxLat],[e.minLon,e.maxLat],[e.minLon,e.minLat]]}};e.initialized&&L.geoJson(c,{style:m}).addTo(map),routingLayer=L.geoJson().addTo(map),routingLayer.options={style:function(e){return e.properties&&e.properties.style},contextmenu:!0,contextmenuItems:[{text:translate.tr("route")+" ",disabled:!0,index:0,state:3},{text:translate.tr("set_intermediate"),callback:a,index:1,state:3},{separator:!0,index:2,state:3}],contextmenuAtiveState:3}}function focus(e,t,a){e.lat&&e.lng&&(t||(t=11),routingLayer.clearLayers(),map.setView(new L.LatLng(e.lat,e.lng),t),mainTemplate.setFlag(e,a))}function getToFrom(e,t){return 0===e?FROM:e===t.route.size()-1?TO:-1}function addOverlayLayer(e,t,a){var o=document.createElement("a");o.href="#",o.className="",o.textContent=e,o.minzoom=a,o.onclick=function(e){if(e.preventDefault(),e.stopPropagation(),"disabled"!==this.className){var a=tileLayers.activeLayer;for(index=0;index<t.length;++index){var n=a._glMap.getLayoutProperty(t[index],"visibility");"visible"===n?(a._glMap.setLayoutProperty(t[index],"visibility","none"),this.className=""):(this.className="active",a._glMap.setLayoutProperty(t[index],"visibility","visible"))}}o.activeClassName=o.className};var n=document.getElementById("layer_menu");n.appendChild(o)}var mainTemplate=require("./main-template.js"),tileLayers=require("./config/tileLayers.js"),translate=require("./translate.js"),routingLayer,map,menuStart,menuIntermediate,menuEnd,elevationControl=null;module.exports.clearLayers=function(){routingLayer.clearLayers()},module.exports.getRoutingLayer=function(){return routingLayer},module.exports.getSubLayers=function(e){var t=routingLayer.getLayers();return t.filter(function(t){return t.feature&&t.feature.properties&&t.feature.properties.name===e})},module.exports.addDataToRoutingLayer=function(e){routingLayer.addData(e)},module.exports.eachLayer=function(e){routingLayer.eachLayer(e)},module.exports.setDisabledForMapsContextMenu=function(e,t){"start"===e&&map.contextmenu.setDisabled(menuStart,t),"end"===e&&map.contextmenu.setDisabled(menuEnd,t),"intermediate"===e&&map.contextmenu.setDisabled(menuIntermediate,t)},module.exports.fitMapToBounds=function(e){map.fitBounds(e)},module.exports.removeLayerFromMap=function(e){map.removeLayer(e)},module.exports.focus=focus,module.exports.initMap=initMap,module.exports.adjustMapSize=adjustMapSize,module.exports.addElevation=function(e,t){null===elevationControl&&(elevationControl=L.control.elevation({position:"bottomright",theme:"white-theme",width:450,height:125,margins:{top:10,right:20,bottom:30,left:60},useHeightIndicator:!0,interpolation:"linear",hoverNumber:{decimalsX:2,decimalsY:0,formatter:void 0},xTicks:void 0,yTicks:void 0,collapsed:!1}),elevationControl.addTo(map)),elevationControl.options.imperial=t,elevationControl.addData(e)},module.exports.clearElevation=function(){elevationControl&&elevationControl.clear()},module.exports.getMap=function(){return map},module.exports.updateScale=function(e){if(null!==scaleControl){scaleControl.removeFrom(map);var t=e?{metric:!1}:{imperial:!1};scaleControl=L.control.scale(t).addTo(map)}};var FROM="from",TO="to",iconFrom=L.icon({iconUrl:"./img/marker-icon-green.png",shadowSize:[50,64],shadowAnchor:[4,62],iconAnchor:[12,40]}),iconTo=L.icon({iconUrl:"./img/marker-icon-red.png",shadowSize:[50,64],shadowAnchor:[4,62],iconAnchor:[12,40]});module.exports.createMarker=function(e,t,a,o,n,i){var r=getToFrom(e,i);return L.marker([t.lat,t.lng],{icon:r===FROM?iconFrom:r===TO?iconTo:new L.NumberedDivIcon({number:e}),draggable:!0,contextmenu:!0,contextmenuItems:[{text:translate.tr("marker")+" "+(r===FROM?translate.tr("start_label"):r===TO?translate.tr("end_label"):translate.tr("intermediate_label")+" "+e),disabled:!0,index:0,state:2},{text:translate.tr(r!==TO?"set_end":"set_start"),callback:r!==TO?a:o,index:2,state:2},{text:translate.tr("delete_from_route"),callback:n,index:3,state:2,disabled:-1!==r&&2===i.route.size()},{separator:!0,index:4,state:2}],contextmenuAtiveState:2}).addTo(routingLayer).bindPopup(r===FROM?translate.tr("start_label"):r===TO?translate.tr("end_label"):translate.tr("intermediate_label")+" "+e)};

},{"./config/tileLayers.js":3,"./main-template.js":17,"./translate.js":27}],19:[function(require,module,exports){
(function (global){
function startLocalVectorTileServer(e){tilesServerHasExited=!1;var t=global.require("child_process").spawn;mbtiles=t("../node.exe",["server.js"],{cwd:"ratrun-mbtiles-server",detached:!1}),stopTileServerMenuItem.enabled=!0,showInstalledMapsMenuItem.enabled=!0,startTileServerMenuItem.enabled=!1,deleteMapMenuItem.enabled=!1,console.log("mbtiles started: "+mbtiles),mbtiles.on("error",function(e){console.log("mbtiles error"+e)}),mbtiles.stdout.on("data",function(e){console.log("mbtiles stdout: "+e)}),mbtiles.stderr.on("data",function(e){console.log("mbtiles stderr: "+e)}),mbtiles.on("close",function(e){console.log("tiles server child process closed with code "+e)}),mbtiles.on("exit",function(e,t){console.log("tiles server child process exited with code "+e+" signal="+t),tilesServerHasExited=!0,setTimeout(function(){"SIGTERM"===t?this.close(!0):100===e?(stopTileServerMenuItem.enabled=!1,showInstalledMapsMenuItem.enabled=!1,startTileServerMenuItem.enabled=!0,deleteMapMenuItem.enabled=!0,showHtmlNotification("./img/mtb.png","Tile server stopped !","")):console.log("Running tile server detected, keep it active")},500)}),mbtiles.on("uncaughtException",function(e){console.log("Caught exception: "+e)})}function startGraphhopperServer(e){var t=global.require("os");console.log("Starting graphhopper");const o=40,n=80;var r=Math.trunc(.4*t.totalmem()/1024e3),i=Math.trunc(.8*t.totalmem()/1024e3);console.log("Installed RAM:"+t.totalmem()+" Bytes. Initial heap "+o+"%="+r+"MB, max heap "+n+"%="+i+"MB");var a=global.require("child_process").spawn;graphhopper=a("java.exe",["-Xmx"+i+"m","-Xms"+r+"m","-jar","graphhopper-web-0.8-SNAPSHOT-with-dep.jar","jetty.resourcebase=../","jetty.port=8989","config=config.properties","datareader.file=osmfiles/"+activeOsmfile,"graph.location=graph"],{cwd:"graphhopper",detached:!1}),console.log("graphhopper started: "+graphhopper),graphhopperServerHasExited=!1,stopGraphhopperServerMenuItem.enabled=!0,changeGraphMenuItem.enabled=!1,startGraphhopperServerMenuItem.enabled=!1,graphhopper.on("error",function(e){console.log("graphhopper error"+e)}),graphhopper.stdout.on("data",function(e){console.log("graphhopper stdout: "+e),-1!==e.toString("utf-8").indexOf("creating graph")&&showHtmlNotification("./img/mtb.png","Creating routing data","might take a while!"),-1!==e.toString("utf-8").indexOf("Started server at HTTP :8989")&&(showHtmlNotification("./img/mtb.png","Routing server","is ready..."),window.location.reload(!0))}),graphhopper.stderr.on("data",function(e){console.log("graphhopper stderr: "+e)}),graphhopper.on("close",function(t){console.log("graphhopper child process closed with code "+t+" shutdownapp="+shutdownapp),graphhopperServerHasExited=!0,showHtmlNotification("./img/mtb.png","Routing server stopped !!",""),shutdownapp&&e.close()}),graphhopper.on("exit",function(t,o){console.log("graphhopper child process exited with code "+t+" signal="+o),graphhopperServerHasExited=!0,shutdownapp&&e.close()}),e.on("close",function(){this.hide(),shutdownapp=!0,console.log("win.on close tilesServerHasExited="+tilesServerHasExited+" ,graphhopperServerHasExited="+graphhopperServerHasExited),tilesServerHasExited&&graphhopperServerHasExited?(console.log("close2"),null!=aboutWindow&&aboutWindow.close(!0),this.close(!0)):(stopLocalVectorTileServer(),stopGraphhopperServer())}),graphhopper.on("uncaughtException",function(e){console.log("Caught exception: "+e)})}function stopLocalVectorTileServer(){if(!tilesServerHasExited){if(shutdownapp){var e=mbtiles.kill("SIGTERM");console.log("mbtiles kill SIGTERM returned:"+e)}else $.getJSON("http://127.0.0.1:3000/4cede326-7166-4cbd-994f-699c6dc271e9",function(e){console.log("Tile server stop response was"+e)});stopTileServerMenuItem.enabled=!1,showInstalledMapsMenuItem.enabled=!1,startTileServerMenuItem.enabled=!0,deleteMapMenuItem.enabled=!0}}function stopGraphhopperServer(){if(!graphhopperServerHasExited){stopGraphhopperServerMenuItem.enabled=!1,changeGraphMenuItem.enabled=!0,startGraphhopperServerMenuItem.enabled=!0;var e=graphhopper.kill("SIGTERM");console.log("graphhopper kill SIGTERM returned:"+e)}}function deletegraph(e){graphhopperServerHasExited?(console.log("Deleting graph in "+e),fs.unlinkSync(e+"/edges"),fs.unlinkSync(e+"/geometry"),fs.unlinkSync(e+"/location_index"),fs.unlinkSync(e+"/names"),fs.unlinkSync(e+"/properties"),fs.unlinkSync(e+"/nodes")):alert("Cannot delete routing data as graphhopper server is still running!")}function webkitapp(e){gui.App.clearCache();var t=new gui.Menu({type:"menubar"});fs=global.require("fs"),fs.existsSync("graphhopper\\osmfiles\\"+activeOsmfile)||(alert("OSM file "+activeOsmfile+" not found!"),localStorage.removeItem("activeOsmfile"));var o=new gui.Menu,n=new gui.MenuItem({type:"separator",enabled:!1});showInstalledMapsMenuItem=new gui.MenuItem({label:"Show installed maps",enabled:tilesServerHasExited,click:function(){$.getJSON("http://127.0.0.1:3000/mbtilesareas.json",function(e){alert("Installed maps: \n"+JSON.stringify(e).replace(/{\"country\"\:\"/g,"").replace(/\"}/g,"\n"))})}}),o.append(showInstalledMapsMenuItem);var r=global.require("./ratrun-mbtiles-server/country_extracts.json");o.append(new gui.MenuItem({label:"Download map",click:function(){var t,o;$("#mapDropDownDest").change(function(){o=$(this).val()}),$(function(){t=$("#map_selection_dialog").dialog({width:420,height:260,autoOpen:!1,resizable:!1,draggable:!1,buttons:{Download:function(){stopLocalVectorTileServer(),showHtmlNotification("./img/mtb.png","Starting download of",o),download("https://osm2vectortiles-downloads.os.zhdk.cloud.switch.ch/v2.0/extracts/"+o+".mbtiles","ratrun-mbtiles-server\\"+o+".mbtiles",function(t){showHtmlNotification("./img/mtb.png","Download result:",t),startLocalVectorTileServer(e)}),$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}})}),$.each(r,function(e,t){void 0==o&&(o=t.extract),console.log("country: "+t.country),$("#mapDropDownDest").append($("<option></option>").val(t.extract).html(t.country))}),$("#map_selection_dialog").dialog("open")}})),deleteMapMenuItem=new gui.MenuItem({label:"Delete map",enabled:!tilesServerHasExited,click:function(){stopLocalVectorTileServer(),chooseFile("#mbtilesFileDialog")}}),o.append(deleteMapMenuItem),stopTileServerMenuItem=new gui.MenuItem({label:"Stop tile server",enabled:tilesServerHasExited,click:function(){stopLocalVectorTileServer()}}),startTileServerMenuItem=new gui.MenuItem({label:"Start tile server",enabled:!tilesServerHasExited,click:function(){startLocalVectorTileServer(e),this.enabled=!1}}),o.append(n),o.append(stopTileServerMenuItem),o.append(startTileServerMenuItem),t.append(new gui.MenuItem({label:"Map",submenu:o}));var i=new gui.Menu,e=gui.Window.get();stopGraphhopperServerMenuItem=new gui.MenuItem({label:"Stop Graphhopper server",enabled:graphhopperServerHasExited,click:function(){console.log("Stop Graphhopper server clicked"),stopGraphhopperServer()}}),startGraphhopperServerMenuItem=new gui.MenuItem({label:"Start Graphhopper server",enabled:!graphhopperServerHasExited,click:function(){console.log("Start Graphhopper server clicked"),startGraphhopperServer(e),this.enabled=!1}}),changeGraphMenuItem=new gui.MenuItem({label:"Change graph",enabled:!graphhopperServerHasExited,click:function(){chooseFile("#osmFileDialog")}}),i.append(changeGraphMenuItem),i.append(n),i.append(new gui.MenuItem({label:"Download OSM data file: Fixme",click:function(){download("https://download.geofabrik.de/europe/liechtenstein-latest.osm.pbf","graphhopper\\osmfiles\\liechtenstein-latest.osm.pbf",function(e){alert("Download OSM resulted in:"+e)})}})),i.append(new gui.MenuItem({label:"Delete OSM data file",enabled:!1})),i.append(n),i.append(stopGraphhopperServerMenuItem),i.append(startGraphhopperServerMenuItem),t.append(new gui.MenuItem({label:"Routing",submenu:i}));var a=new gui.Menu;a.append(new gui.MenuItem({label:"Help: Fixme",enabled:!1})),a.append(n),a.append(new gui.MenuItem({label:"About",click:function(){var e={resizable:!1,show:!0,height:270,width:450};null==aboutWindow&&(aboutWindow=gui.Window.open("about.html",e),aboutWindow.on("document-end",function(){aboutWindow.focus(),$(aboutWindow.window.document).find("a").bind("click",function(e){e.preventDefault(),gui.Shell.openExternal(this.href)})})),aboutWindow.on("close",function(){aboutWindow.close(!0),aboutWindow=null})}})),t.append(new gui.MenuItem({label:"Help",submenu:a})),gui.Window.get().menu=t,startLocalVectorTileServer(e),startGraphhopperServer(e)}function chooseFile(e){var t=$(e);t.unbind("change"),t.change(function(t){if("#osmFileDialog"===e)activeOsmfile=$(this).val().split(/(\\|\/)/g).pop(),console.log("Selected OSM file:"+activeOsmfile),localStorage.activeOsmfile=activeOsmfile,deletegraph("graphhopper/graph"),startGraphhopperServer(win);else if("#mbtilesFileDialog"===e){var o=$(this).val();fileName=o.split(/(\\|\/)/g).pop(),console.log("fileName:"+fileName),-1===fileName.indexOf("bicycle")?(console.log("Delete map file:"+o),fs.unlinkSync(o)):showHtmlNotification("./img/warning.png","Avoid deletion of protected file!",fileName)}}),t.trigger("click")}var mbtiles,graphhopper,stopTileServerMenuItem,startTileServerMenuItem,stopGraphhopperServerMenuItem,startGraphhopperServerMenuItem,showInstalledMapsMenuItem,changeGraphMenuItem,deleteMapMenuItem,aboutWindow=null,selectCountryWindow=null,tilesServerHasExited=!0,graphhopperServerHasExited=!0,shutdownapp=!1,fs,activeOsmfile=localStorage.activeOsmfile,gui;void 0===activeOsmfile&&(activeOsmfile="liechtenstein-latest.osm.pbf");var download=function(e,t,o){var n=global.require("https"),r=fs.createWriteStream(t),i=n.get(e,function(t){return 200!==t.statusCode?o("Response status was "+t.statusCode):(t.pipe(r),void r.on("finish",function(){r.close(o("Download of "+e+" finished!"))}))});i.on("error",function(e){return fs.unlink(t),o?o(e.message):void 0}),r.on("error",function(e){return fs.unlink(t),o?o(e.message):void 0})},showHtmlNotification=function(e,t,o,n){var r=showNotification(e,t,o);setTimeout(function(){r.close()},6e3)},writeLog=function(e){var t=$("#output");t.innerHTML+=e+"<br>",t.scrollTop=t.scrollHeight},showNotification=function(e,t,o){var n=new Notification(t,{icon:e,body:o});return n.onshow=function(){writeLog("-----<br>"+t)},n};try{gui=nw;var win=gui.Window.get();webkitapp(win)}catch(err){console.log("We are not running under nw"+err)}

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{}],20:[function(require,module,exports){
module.exports.extractMetaVersionInfo=function(e){return metaVersionInfo="",e.data_date&&(metaVersionInfo+="<br/>Data date: "+e.data_date),e.import_date&&(metaVersionInfo+="<br/>Import date: "+e.import_date),e.prepare_date&&(metaVersionInfo+="<br/>Prepare date: "+e.prepare_date),e.version&&(metaVersionInfo+="<br/>GH version: "+e.version),e.build_date&&(metaVersionInfo+="<br/>Jar date: "+e.build_date),metaVersionInfo},module.exports.getSignName=function(e){if(-3===e)return"sharp_left";if(-2===e)return"left";if(-1===e)return"slight_left";if(0===e)return"continue";if(1===e)return"slight_right";if(2===e)return"right";if(3===e)return"sharp_right";if(4===e)return"marker-icon-red";if(5===e)return"marker-icon-blue";if(6===e)return"roundabout";throw"did not find sign "+e},module.exports.browserTitle="Biketourplaner";
...
},{"./tools/format.js":23,"./tools/math.js":24}],22:[function(require,module,exports){
var L=require("leaflet");module.exports.getIntermediatePointIndex=function(n,e){for(var t=function(n){return n.coordinates.map(function(n,t){return{index:t,distance:L.latLng(n).distanceTo(e)}}).reduce(function(n,e){return e.distance<n.distance?e:n})},i=n.map(function(n){return n.closestPoint=t(n),n}).reduce(function(n,e){return e.closestPoint.distance<n.closestPoint.distance?e:n}),r=i.coordinates,o=i.wayPoints,c=1,a=i.closestPoint.index;a<r.length;++a){var s=o.findIndex(function(n){return r[a].equals(n,.001)});if(-1!==s){c=0===s?1:s;break}}return c};

},{"leaflet":31}],23:[function(require,module,exports){
...
},{"./tools/math.js":24}],28:[function(require,module,exports){
...
module.exports={
    ...
    "sources": {
        "mapbox": {
            "type": "vector",
            "tiles": [ 
                 "http://localhost:3000/austria/{z}/{x}/{y}.pbf"
            ],
            "maxzoom": 14
        },
        "bicyclenodes": {
            "type": "vector",
            "tiles": [ 
                 "http://localhost:3000/bicyclenodes/{z}/{x}/{y}.pbf"
            ],
            "minzoom": 5,
            "maxzoom": 14
        },
        "bicycleroutes": {
            "type": "vector",
            "tiles": [ 
                 "http://localhost:3000/bicycleroutes/{z}/{x}/{y}.pbf"
            ],
            "minzoom": 5,
            "maxzoom": 14
        }        
    },
    "sprite": "/assets/bright-v8",
    ...
    "layers": [
        ...
        },
        {
            ...
            "maxzoom": 12,
            "layout": {
                "icon-image": "campsite-12",
                "visibility": "none"
            }
        },
        {
            "id": "poi_campsites_label",
            "type": "symbol",
            "source": "bicyclenodes",
            "source-layer": "bicyclenodes",
            "filter": [
        ...
        },
        {
            ...
            "minzoom": 7,
            "layout": {
                "icon-image": "bicycle-shop-12",
                "visibility": "none"
            }
        },
        {
            "id": "poi_label_bicycle_shops",
            "type": "symbol",
            "source": "bicyclenodes",
            "source-layer": "bicyclenodes",
            "filter": [
        ...
        },
        {
          "id": "icn_ncn-unpaved",
          "type": "line",
          "source": "bicycleroutes",
          "source-layer": "bicycleroutes",
          "filter": [
               "all",
               [
                "in",
