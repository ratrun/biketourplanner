...
public class GraphHopperIT {
    ...
    public void testMonacoWithInstructions() throws Exception {
        ...
        WayTypeInfo wayTypeIno = arsp.getWayTypeInfo();
    ...
    public void testAlternativeRoutesBikeAndCar() {
        ...
        assertEquals(3570, rsp.getAll().get(2).getTime() / 1000);
...
*/
    ...
    public void testSRTMWithInstructions() throws Exception {
        ...
        assertEquals(8.0, arsp.getAscend(), 1e-1);
        assertEquals(59, arsp.getDescend(), 1e-1);
    ...
    public void testKremsCyclewayInstructionsWithWayTypeInfo() {
        ...
        WayTypeInfo wayTypeIno = arsp.getWayTypeInfo();
        assertEquals(3108.7 , wayTypeIno.getCyclewayDistance(), .1);
        ...
        assertEquals(2093.3 , wayTypeIno.getRoadDistance(), .1);
...
@Test
    public void testRoundTour() {
        ...
        assertEquals(61, pw.getPoints().size());
    }
